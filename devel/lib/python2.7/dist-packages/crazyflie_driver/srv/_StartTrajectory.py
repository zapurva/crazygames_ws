...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2Bf2B.pack(_x.groupMask, _x.trajectoryId, _x.timescale, _x.reversed, _x.relative))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.groupMask, _x.trajectoryId, _x.timescale, _x.reversed, _x.relative,) = _struct_2Bf2B.unpack(str[start:end])
